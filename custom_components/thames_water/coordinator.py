...
# The charges are an annual scheme running from 1 April, so a yearly cache
# would match them, and would hide a break in the page parser for that long.
# Weekly surfaces one in days, at one unauthenticated GET on a public page.
